...
class MapViewModel : ViewModel() {
    ...
    fun addMarker(p: LatLng, title: String, snippet: String = "") = uiVar.update { it.copy(markers = it.markers + MyMarker(p, title, snippet)) }
    fun clearMarkers() = uiVar.update { it.copy(markers = emptyList(), showCurrentMarker = false, routePoints = emptyList()) }
